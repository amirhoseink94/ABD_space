...
int main()
{
	...
	*/
	...
	int mesh_parameter = 3;

	Shape ABC_m = make_mesh(ABC, mesh_parameter);
	Shape BCD_m = make_mesh(BCD, mesh_parameter);
	Shape ABF_m = make_mesh(ABF, mesh_parameter);
	Shape BDF_m = make_mesh(BDF, mesh_parameter);

	Shape AEC_m = make_mesh(AEC, mesh_parameter);
	Shape ECD_m = make_mesh(ECD, mesh_parameter);
	Shape AEF_m = make_mesh(AEF, mesh_parameter);
	Shape EDF_m = make_mesh(EDF, mesh_parameter);
